...
const baseTheme = {
  primaryColor: '#00dc82', // Cyberpunk Emerald Green
...
const lightTheme = {
  ...
  buttonHoverBackground: '#e6fffa',
  scrollbarTrack: '#f1f1f1',
  scrollbarThumb: '#888888',
  scrollbarThumbHover: '#555555',
  modalOverlay: 'rgba(0, 0, 0, 0.5)',
  primaryColor: '#00b86b', // Slightly darker for light mode contrast
...
const darkTheme = {
  ...
  textColor: '#ffffff',
  backgroundColor: '#0f172a', // Deep slate blue/black for modern feel
  borderColor: '#1e293b',
  invertedTextColor: '#0f172a',
  buttonHoverBackground: '#1e293b',
  scrollbarTrack: '#1e293b',
  scrollbarThumb: '#475569',
  scrollbarThumbHover: '#64748b',
  modalOverlay: 'rgba(0, 0, 0, 0.7)',
  accentColor: '#0ea5e9', // Sky blue accent
};
